...
#ifndef INTERVAL_SWIFT_H
#define INTERVAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Interval",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC8Interval15LocationManager")
...
SWIFT_CLASS("_TtC8Interval20PlaceSearchCompleter")
...
@class WCSession;
SWIFT_CLASS("_TtC8Interval16WatchSyncManager")
@interface WatchSyncManager : NSObject <WCSessionDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
